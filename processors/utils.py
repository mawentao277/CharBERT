...
class InputFeatures(object):
    ...
    def __init__(self, char_input_ids, start_ids, end_ids, input_ids, attention_mask=None, token_type_ids=None, label=None):
...
def load_char_to_ids_dict(char_vocab_file="./data/dict/bert_char_vocab"):
