...
from transformers import WEIGHTS_NAME, RobertaTokenizer, BertTokenizer
from transformers import AdamW, get_linear_schedule_with_warmup
from processors.squad import squad_convert_examples_to_features
from modeling.configuration_bert import BertConfig
from modeling.modeling_charbert import CharBertModel, CharBertForQuestionAnswering
from modeling.configuration_roberta import RobertaConfig
from modeling.modeling_roberta import RobertaForQuestionAnswering
...
MODEL_CLASSES = {
    'bert': (BertConfig, CharBertForQuestionAnswering, BertTokenizer),
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.model_type != 'distilbert':
                inputs['token_type_ids'] = None if args.model_type == 'xlm' else batch[5]
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            if args.model_type != 'distilbert':
                inputs['token_type_ids'] = None if args.model_type == 'xlm' else batch[5]  # XLM don't use segment_ids
...
def main():
    ...
    parser.add_argument("--data_version", default="", type=str,
                        help="the version of the cached data")
    ...
    print(f"version_2_with_negative: {args.version_2_with_negative}")
    ...
    tokenizer = tokenizer_class.from_pretrained(args.tokenizer_name if args.tokenizer_name else args.model_name_or_path,
                                                ...
                                                cache_dir=args.cache_dir if args.cache_dir else None)
    print(f'model_name_or_path in train function: {args.model_name_or_path}')
